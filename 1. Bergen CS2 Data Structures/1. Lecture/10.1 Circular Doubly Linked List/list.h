...
In the development/planning phase of this program, I goofed by making this program circular.
This means that _head and _tail and linked to each other when they don't need to be.
Instead, _head->getPrev() should return nullptr, and _tail->getNext() should return nullptr.
See 3. Labs/4. Doubly Linked List/ for proper doubly linked list code.
*/
